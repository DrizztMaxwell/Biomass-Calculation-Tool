                    ...
                    ft.Container(
                        ...
                        content=ft.Text(
                            spans=[
                                ...
                                ft.TextSpan("Your dataset must be a ", style=ft.TextStyle(color=ft.Colors.BLACK)),
                                ft.TextSpan("tab-delimited TXT file", style=ft.TextStyle(weight=ft.FontWeight.BOLD, color=ft.Colors.BLACK)),
                                ft.TextSpan(" with columns: ", style=ft.TextStyle(color=ft.Colors.BLACK)),
