...
class SideNavBar_View:
    ...
    def _exit_application_direct(self):
        ...
        # Minimal cleanup - avoid any methods that might trigger UI updates
        try:
            # Direct cleanup without callbacks
            if hasattr(self, 'main_controller') and hasattr(self.main_controller, 'cleanup'):
    ...
    def navigate_to_page(self, page_name: str):
        ...
        try:
            ...
            import threading
            threading.Timer(0.5, lambda: setattr(self, '_navigating', False)).start()
