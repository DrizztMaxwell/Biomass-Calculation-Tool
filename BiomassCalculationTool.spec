...
a = Analysis(
    ...
    hiddenimports=['views.EULA', 'pyautogui', 'pandas', 'config', 'flet', 'plotly', 'pyodbc', 'matplotlib', 'views', 'flet_core', 'PIL', 'pyarrow', 'openpyxl', 'json', 'widgets', 'seaborn', 'flet_runtime', 'numpy', 'data', 'Pillow', 'asyncio', 'controller'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
