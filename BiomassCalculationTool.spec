...
a = Analysis(
    ...
    hiddenimports=['flet_core', 'json', 'data', 'plotly', 'flet_runtime', 'matplotlib', 'controller', 'config', 'PIL', 'pyarrow', 'pyodbc', 'Pillow', 'openpyxl', 'seaborn', 'widgets', 'flet', 'pandas', 'numpy', 'views.EULA', 'pyautogui', 'asyncio', 'views'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
