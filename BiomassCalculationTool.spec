...
a = Analysis(
    ...
    hiddenimports=['data', 'seaborn', 'flet_runtime', 'numpy', 'views', 'widgets', 'plotly', 'flet', 'PIL', 'pandas', 'json', 'flet_core', 'asyncio', 'config', 'controller', 'views.EULA', 'Pillow', 'openpyxl', 'pyodbc', 'matplotlib'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
