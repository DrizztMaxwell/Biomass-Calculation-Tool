...
a = Analysis(
    ...
    hiddenimports=['pandas', 'plotly', 'seaborn', 'matplotlib', 'views.EULA', 'openpyxl', 'PIL', 'numpy', 'pyodbc', 'json', 'flet', 'flet_core', 'asyncio', 'flet_runtime', 'config', 'controller', 'Pillow', 'views', 'widgets', 'data'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
